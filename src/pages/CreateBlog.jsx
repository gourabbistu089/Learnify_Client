...
function CreateBlog() {
  ...
  const validateForm = () => {
    ...
    if (!formData.content.trim() || formData.content === '<p><br></p>' || formData.content === '<p></p>') {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Blog created successfully!', {...formData});
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white relative">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Share your knowledge and inspire others with compelling stories and insights.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="space-y-8">
          ...
          <div className="relative bg-gradient-to-br from-[#1A1A1A]/90 to-[#0F0F0F]/80 backdrop-blur-sm border border-richblue-300/70 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-[11px] bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] rounded-xl">
                <ImageIcon className="w-7 h-7 text-white" />
              </div>
              <div>
                <h2 className="text-xl font-bold">Featured Image</h2>
                <p className="text-gray-400 text-sm">Upload a compelling cover image for your article</p>
              </div>
            </div>
            ...
            <div className="relative">
              {!imagePreview ? (
                <div
                  ...
                  className="border-2 border-dashed border-richblack-400 rounded-xl p-12 text-center cursor-pointer hover:border-[#6366F1] transition-colors group"
                >
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-400 text-sm mb-4">Click to browse or drag and drop</p>
            ...
            {errors.featuredImage && (
              <p className="text-red-400 text-sm mt-2">{errors.featuredImage}</p>
            )}
          </div>
          ...
          <div className="relative bg-gradient-to-br from-[#1A1A1A]/90 to-[#0F0F0F]/80 backdrop-blur-sm border border-richblue-300/70 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Add relevant tags to help readers find your content</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {formData.tags.map((tag, index) => {
                ...
                return (
                  <span
                    key={index}
                    className={`inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r ${colorClass} border rounded-full text-sm font-medium backdrop-blur-sm`}
                  >
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 bg-[#0A0A0A] border border-richblack-500 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-[#6366F1] transition-colors"
                onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addTag())}
              />
              <button
                type="button"
                onClick={addTag}
                className="px-6 py-3 bg-gradient-to-r from-[#10B981] to-[#34D399] text-white rounded-xl hover:shadow-lg hover:shadow-[#10B981]/25 transition-all duration-300 flex items-center gap-2"
              >
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Write your article content using the rich text editor</p>
                </div>
              </div>
      ...
      <style jsx>{`
        ...
        .border-dashed:hover::before {
          ...
          position: absolute;
          inset: -2px;
          background: linear-gradient(45deg, #6366F160, #8B5CF670, #EC489965, #10B98175);
          border-radius: 12px;
          z-index: -1;
          opacity: 0.3;
        }
