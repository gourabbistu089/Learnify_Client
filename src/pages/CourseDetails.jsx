...
function CourseDetails() {
  ...
  useEffect(() => {
    const Enrolled = courseDetails?.studentsEnrolled?.find(
      (_id) => _id === user?._id
    );
    ...
    <div className=" px-2 md:px-0">
      <div className="mx-auto box-content px-4 lg:w-[1260px] lg:relative ">
          ...
          <div className="z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-richblack-5">
            ...
            <div className="flex flex-wrap gap-5 text-lg">
              ...
              <p className="text-richblack-50">
                Created at &nbsp;
                {new Date(
                  courseDetails?.createdAt || courseDetails?.updatedAt
              ...
              <>
                {alreadyEnrolled ? (
                  <button
                    ...
                    className=" bg-yellow-200 px-3 py-2 text-center text-sm font-semibold text-richblack-900"
                  >
                    Go to Course
                  </button>
                ) : (
                ...
                {alreadyEnrolled ? (
                  ...
                  <button
                    ...
                    className=" bg-richblack-800 px-3 py-2 text-center text-sm font-semibold text-richblack-50"
                  >
                    Go to Cart
                  </button>
                ) : (
        ...
        <div className="right-[1rem] top-[60px] mx-auto hidden min-h-[600px] w-1/3 max-w-[410px] translate-y-24 md:translate-y-0 lg:absolute  lg:block">
          <div className="flex flex-col gap-4 rounded-md bg-richblack-800/70 p-4 text-richblack-5">
            <img
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          <div className="my-8 border border-richblack-600 p-8">
            ...
            <div className="mt-5">{courseDetails?.whatYouWillLearn}</div>
          </div>
