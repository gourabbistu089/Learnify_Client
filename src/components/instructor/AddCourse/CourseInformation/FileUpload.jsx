...
const FileUpload = ({name, label, register, errors, setValue}) => {
  ...
  <div className="bg-richblack-800 flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-richblack-300">
    <div
    ...
    >
      ...
      <div className="grid aspect-square w-14 place-items-center rounded-full bg-blue-800">
        <svg
          stroke="currentColor"
          fill="none"
          strokeWidth="2"
